      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex -mr-14 overflow-visible">
          <Image
            ...
            width={2667}
            height={0}
            className="h-auto object-contain rounded-xl shadow-[0_-20px_40px_-12px_rgba(232,73,42,0.5),20px_0_40px_-12px_rgba(232,73,42,0.5),-20px_0_40px_-12px_rgba(232,73,42,0.5),0_20px_40px_-12px_rgba(232,73,42,0.5)]"
          />
        </div>
      </div>
    </section>
